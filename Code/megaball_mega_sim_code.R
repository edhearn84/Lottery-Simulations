...
n_sims = 1e4
lottery_sims = lapply( rep(339,n_sims) , function(x) sim_lottos(x,ball_count = 46) )
...
real_sims %>%
  ...
  labs( title = "1-46 Mega (before 10/2013) Rolls" ,
...
# Simulate lottery draws for specific period of semi-weekly draws
n_sims = 1e4
lottery_sims = lapply( rep(388,n_sims) , function(x) sim_lottos(x,ball_count = 15) )
...
real_sims %>%
  ...
  theme( axis.ticks.y = element_blank() ,
         axis.text.y = element_blank() ) +
  labs( title = "1-15 Mega (10/2013 - 10/2017) Rolls" ,
        y = "Ball number (+2/-2 SD bands)" ,
...
# Simulate lottery draws for specific period of semi-weekly draws
n_sims = 1e4
lottery_sims = lapply( rep(125,n_sims) , function(x) sim_lottos(x,ball_count = 25) )
...
real_sims %>%
  ...
  theme( axis.ticks.y = element_blank() ,
         axis.text.y = element_blank() ) +
  labs( title = "1-25 Mega (post-10/2017) Rolls" ,
        y = "Ball number (+2/-2 SD bands)" ,
